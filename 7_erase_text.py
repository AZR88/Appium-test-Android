...
driver.find_element(By.ID, "com.socialnmobile.dictapps.notepad.color.note:id/edit_note").clear()
driver.find_element(By.ID, "com.socialnmobile.dictapps.notepad.color.note:id/edit_note").send_keys("Test Notes 1 Edit")
driver.find_element(By.ID, "com.socialnmobile.dictapps.notepad.color.note:id/back_btn").click()
driver.find_element(By.ID, "com.socialnmobile.dictapps.notepad.color.note:id/back_btn").click()
